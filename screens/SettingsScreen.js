  ...
  return(
    <View style={[styles.screenContainer, {backgroundColor: colors.background}]}>
      ...
      <View style={styles.middleContainer}>
        ...
        <Button title="Privacy" titleStyle={{color: colors.text}} buttonStyle={{ justifyContent: 'flex-start', borderBottomWidth:1, borderBottomColor: colors.card }} type="clear" icon={<Ionicons name="md-finger-print-outline" size={28} style={{ marginRight: 10, color: colors.primary}}/>} onPress={() => (navigation.navigate("Privacy"))}/>
